...
const RegisterPage = () => {
  ...
  const registerKanban = () => {
    ...
    apiKanban.post('auth/signup', {username: values.email, password: values.password,confirmPassword: values.password })
  }
    ...
    try {
      ...
      api.post('api/users', {name: values.name,email : values.email, password: values.password}).then((data) => {
        ...
        if(data.data.message === 'Nao podemos criar outro usuário com o mesmo email') {
          ...
          alert('Usuário com mesmo email já encontrado')
      ...
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
            ...
            <FormControl fullWidth>
              <InputLabel htmlFor='auth-register-password'>Confirmação de Senha</InputLabel>
            ...
            <FormControlLabel
              ...
              label={
                <Fragment>
                  <span>Eu aceito a </span>
                  <Link href='/' passHref>
                    <LinkStyled onClick={e => e.preventDefault()}>política de privacidade</LinkStyled>
                  </Link>
                </Fragment>
              }
            />

            {
              ...
              Registrar
                ...
                <Button fullWidth size='large' type='submit' variant='contained' sx={{ marginBottom: 7, backgroundColor:'#635f5b',}}>
                Registrar
            </Button>
              )
            }
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
              ...
              <Typography variant='body2'>
                <Link passHref href='/pages/login'>
                  <LinkStyled>Efetue o Login</LinkStyled>
                </Link>
              </Typography>
            </Box>
